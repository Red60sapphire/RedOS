...
const newcontextmenu = new red.ContextMenu();
// This context menu is for applications and libraries
const appcontextmenu = new red.ContextMenu();
// This context menu is for when no files are selected
const emptycontextmenu = new red.ContextMenu();
...
document.addEventListener("contextmenu", (e) => {
	...
	const containsApps =
		currentlySelected
			.map((item) => item.getAttribute("data-path").split(".").slice("-1")[0])
