...
class AltTabView {
			...
			<div>
				...
				>
					<div class="alttab-window-icon-container">
						<img class="alttab-icon-large" src={app?.icon} alt="App Icon" />
					</div>
				</div>
				<div class="alttab-titlebar">
					<img class="alttab-icon-inline" src={app?.icon} alt="App Icon" />
	...
	update() {
		const windows = Object.values(red.apps).flatMap(
