namespace ReddHelpers {
	/**
	 * This array will be updated at runtime as red api's are registered
	 */
	const apis: string[] = [];
	/**
	 * This array will be updated at runtime as red stages are completed
...
class ReddHelpersLib extends Lib {
	icon = "/assets/icons/generic.svg";
	package = "red.daemon.helpers";
	name = "Redd Helpers";
