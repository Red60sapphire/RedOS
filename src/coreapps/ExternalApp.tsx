interface AppManifest {
	 ...
	 * specified in the index field. If the type is not "manual" or "auto", it will be handled by the red
	 ...
	 * worrying about the app purging red's own databases.
	 */
...
class ExternalApp extends App {
	...
	async open(args: string[] = []): Promise<WMWindow | undefined> {
		if (this.manifest.type === "auto") {
			const win = red.wm.create(this, this.manifest.wininfo);
			...
			// This type of application is reserved only for scripts meant for hacking red internals
