		...
		<div class={this.css}>
			...
			<div class="recovery-app-content">
				...
				<button
					...
					title="Reset your Red install to factory settings. This will delete all of your data."
					on:click={async () => {
						if (
				...
				<button
					...
					on:click={() => {
						const term = red.apps["red.ashell"];
						if (term) {
							term.open();
						} else {
